...
def get_tokens():
    ...
    access_token_url = 'https://www.tumblr.com/oembed'
...
r = oauth.get("https://www.tumblr.com/oembed/", params = {'q': 'University of Michigan', 'count' : 3})
...
for i in range(5):
    ...
    r = oauth.get("https://www.tumblr.com/oembed.json",params = my_params)  # passes {'count': 5, 'max_id': whatever} ...
